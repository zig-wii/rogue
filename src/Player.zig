...
pub fn drawSprite(self: *Player, comptime sprite: main.Sprite) void {
...
pub fn run(self: *Player, state: *main.State) void {
    // Exit
    ...
    switch (self.*.state) {
        ...
        .attack => |*attack| {
            // Draw spinning sword
            main.Sprite.player_sword.draw(self.sword_area().?);
